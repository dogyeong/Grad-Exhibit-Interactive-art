...
public class DwPhysics<T extends DwParticle> {
  ...
  public void addParticles(T[] particles_add, int particles_add_count, int cnt){
    ...
    if(particles == null){
      ...
      //particles_add = Arrays.copyOf(particles_add, particles_count + particles_add_count);
      //System.arraycopy(particles, 0, particles_add, particles_add_count, particles_count);
      //particles = Arrays.copyOf(particles_add, particles_count + particles_add_count);
      //particles_count += particles_add_count;
      if(cnt < psLimit) {
        particles = Arrays.copyOf(particles, particles_count + particles_add_count);
        System.arraycopy(particles_add, 0, particles, particles_count, particles_add_count);
        ...
        for(int i = 0; i < particles_add_count; i++) {
          particles[cnt%psLimit*particles_add_count+i] = particles_add[i];  
        }
      }
    }
