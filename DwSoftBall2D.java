...
public class DwSoftBall2D extends DwSoftBody2D{
  ...
  public void create(DwPhysics<DwParticle2D> physics, float circle_x, float circle_y, float cirlce_r, float nodes_r, int cnt){
    ...
    physics.addParticles(particles, num_nodes, cnt);
  }
